...
class Game:
    ...
    def __init__(self):
        ...
        self.wpm = 0
        self.end = 0
        self.HEAD_C = (255, 213, 202)
        self.TEXT_C = (240, 240, 240)
        self.RESULT_C = (255, 70, 70)

        pygame.init()
        self.open_img = pygame.image.load('images.jpg')
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        self.bg = pygame.image.load('images.jpg')
        self.bg = pygame.transform.scale(self.bg, (500, 750))
        self.screen = pygame.display.set_mode((self.w, self.h))
        pygame.display.set_caption('Creed Typing Game')
    ...
    def show_results(self, screen):
        if not self.end:
            ...
            # screen.blit(self.time_img(self.time_img, (80, 320)
